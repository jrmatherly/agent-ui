  ...
  return (
    ...
    >
      <div className="flex max-w-3xl flex-col gap-y-8">
        ...
        >
          <div className="flex items-center justify-center gap-x-2 font-medium whitespace-nowrap">
                ...
                {TECH_ICONS.map((icon) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <motion.div
                        className="text-primary pointer-events-none absolute bottom-full left-1/2 mb-1 -translate-x-1/2 transform rounded bg-neutral-800 px-2 py-1 text-xs whitespace-nowrap"
