    ...
    <div>
      <div className="group relative w-full max-w-xl">
        ...
        <button
          ...
          className="bg-secondary/80 hover:bg-secondary absolute top-2 right-2 flex items-center justify-center rounded-xs p-1.5 opacity-0 transition-opacity duration-200 group-hover:opacity-100"
