...
const Sessions = () => {
  ...
  return (
    <div className="flex min-h-0 w-full flex-1 flex-col">
      ...
      <div
        className={`font-geist min-h-0 flex-1 overflow-y-auto transition-all duration-300 [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar]:transition-opacity [&::-webkit-scrollbar]:duration-300 ${
          isScrolling
            ? '[&::-webkit-scrollbar-thumb]:bg-background [&::-webkit-scrollbar]:opacity-0 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-transparent'
