...
const Endpoint = () => {
  ...
  const [endpointValue, setEndpointValue] = useState(selectedEndpoint)
  ...
  // Sync endpointValue when selectedEndpoint changes externally
  useEffect(() => {
          ...
          >
            <AnimatePresence mode="wait">
              {isHovering ? (
                ...
                >
                  <p className="text-primary flex items-center gap-2 text-xs font-medium whitespace-nowrap">
